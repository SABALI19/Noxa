  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={`
          w-full border bg-white dark:bg-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-600 
          focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
          ${sizeClasses[size]}
          ${paddingLeft} ${paddingRight}
          ${disabled ? "bg-gray-100 dark:bg-gray-700 cursor-not-allowed" : ""}
          ${error ? "border-red-500 dark:border-red-400 focus:ring-red-200 dark:focus:ring-red-900" : "border-gray-300 dark:border-gray-600"}
          ${className}
        `}
      />
      ...
      {loading ? (
        <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 animate-spin">
