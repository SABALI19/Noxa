        ...
        >
          ...
          <div className="mt-2">
            {menuItems.map((item) => {
              ...
              // If appearance, render as button instead of Link
              if (item.id === 'appearance') {
                return (
                  ...
                  >
                    ...
                    >
                      <span className="text-[#3D9B9B] group-hover:text-white">
                        {item.icon}
                      </span>
                      <p className="group-hover:text-white text-sm md:text-base font-medium whitespace-nowrap">
                        {item.label}
                      </p>
                    </Button>
                  </button>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <p className="group-hover:text-white text-sm md:text-base lg:text-lg font-medium whitespace-nowrap transition-opacity duration-300">
                        {item.label}
                      </p>
                    )}
                  </Button>
