...
const SetReminderModal = ({ isOpen, onClose, onSubmit, linkedGoal = null, linkedTask = null }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 w-full max-w-2xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 md:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-teal-100 rounded-lg">
              <FiBell className="text-teal-600" />
            </div>
            <div className="min-w-0">
              <h2 className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100">Set a Reminder</h2>
          ...
          <button
            onClick={handleClose}
            className="p-2 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors flex-shrink-0"
          >
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="p-4 md:p-6 space-y-6">
            ...
            {(linkedGoal || linkedTask) && (
              <div className={`p-4 rounded-xl border-2 ${
                linkedGoal ? 'bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-900/40' : 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-900/40'
              }`}>
                <div className="flex items-center gap-3">
                  {linkedGoal ? (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500/30 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${
            ...
            <div>
              ...
              <textarea
                ...
                rows="3"
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500/30 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
              />
            </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <FiCalendar className="text-gray-400 dark:text-gray-500 flex-shrink-0" />
                    <input
                      type="date"
                      value={formData.reminderDate}
                      onChange={(e) => handleDateChange('reminderDate', e.target.value)}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500/30 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${
                        errors.reminderDate ? 'border-red-300' : 'border-gray-300 dark:border-gray-700'
                      }`}
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    <FiClock className="text-gray-400 dark:text-gray-500 flex-shrink-0" />
                    <input
                      type="time"
                      value={formData.reminderTime}
                      onChange={(e) => handleDateChange('reminderTime', e.target.value)}
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500/30 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 ${
                        errors.reminderTime ? 'border-red-300' : 'border-gray-300 dark:border-gray-700'
                      }`}
                    />
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-teal-400 dark:focus:ring-teal-500/30 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                    />
                  </div>
                  <div className="flex items-center gap-2">
                    <FiClock className="text-gray-400 dark:text-gray-500 flex-shrink-0" />
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      className="hidden"
                    />
                    <FiRepeat className="text-gray-400 dark:text-gray-500 flex-shrink-0" />
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 pt-6">
              <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-4">Advanced Options</h3>
              <div className="space-y-3">
                <label className="flex items-center justify-between cursor-pointer group">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="p-2 bg-amber-50 dark:bg-amber-900/20 rounded-lg group-hover:bg-amber-100 dark:group-hover:bg-amber-900/35 transition-colors flex-shrink-0">
                      <FiBell className="text-amber-600" />
                    </div>
                    <div className="min-w-0">
                      <p className="font-medium text-gray-900 dark:text-gray-100">Auto-snooze if not completed</p>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Automatically snooze reminder after 1 hour</p>
                    </div>
                  </div>
                ...
                <label className="flex items-center justify-between cursor-pointer group">
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className="p-2 bg-green-50 dark:bg-green-900/20 rounded-lg group-hover:bg-green-100 dark:group-hover:bg-green-900/35 transition-colors flex-shrink-0">
                      <FiBell className="text-green-600" />
                    </div>
                    <div className="min-w-0">
                      <p className="font-medium text-gray-900 dark:text-gray-100">Auto-mark as completed</p>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Mark as completed when due date passes</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer ml-3 flex-shrink-0">
                    <input
          ...
          {/* Footer */}
          <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-4 md:px-6 py-4">
